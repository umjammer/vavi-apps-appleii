...
public class AppleDisplay implements Runnable {
    ...
    private final boolean[] graphicsDirty = new boolean[0x6000 >> 7];
    ...
    // Display composition
    private final int[] displayImageBuffer;
    ...
    private final int[] charSet = new int[CHARSET_SIZE_X * CHARSET_CHAR_SIZE_Y];
    private int[] charMap;
    private final int[][] charMaps = new int[3][0x100];
    private long charMapFlashCycle = 0;
    private boolean isCharMapFlash = false;

    private final int[][] charMapLookup = {
    ...
    private final int[] hiresWord = new int[8];
    private final int[] hiresWordNext = new int[8];
    private final int[] hiresLookup = new int[0x100];    // Bits: [NNccccPP] - Next, current, Previous bits
    ...
    public String getStatInfo() {
        ...
        if (refreshDelayPerSecond > 1000) {
            refreshRateCurrent = refreshRate * 1000L / refreshDelayPerSecond;
        } else {
    ...
    private void loadCharSet() {
        ...
        // Get RGB image
        apple.view.getCharSet(charSet, CHARSET_SOURCE_SIZE_X, CHARSET_SOURCE_SIZE_Y, CHARSET_SIZE_X);
     ...
     * Render text canvas
     */
    private void renderTextScanLine(int destOffset, int sourceOffset) {
    ...
    private void renderTextCharacter(int destOffset, int sourceOffset) {
        renderTextScanLine(destOffset, sourceOffset);
        destOffset += DISPLAY_SIZE_X;
        sourceOffset += CHARSET_SIZE_X;
        renderTextScanLine(destOffset, sourceOffset);
        destOffset += DISPLAY_SIZE_X;
        sourceOffset += CHARSET_SIZE_X;
        renderTextScanLine(destOffset, sourceOffset);
     ...
     */
    private void renderDoubleTextScanLine(int destOffset, int sourceOffset) {
    ...
    private void renderDoubleTextCharacter(int destOffset, int sourceOffset) {
     ...
     * Render lores canvas
     */
    private void renderLoresScanLine(int destOffset, int color) {
    ...
    private void renderLoresBlock(int destOffset, int colorTop, int colorBottom) {
     ...
     * Render hires canvas
     */
    private void renderHiresWord(int destOffset, int hiresNibble) {
    ...
    private void renderHiresScanLine(int destOffset, int hiresWord) {
    ...
    private void renderHiresBlock(int destOffset) {
        renderHiresScanLine(destOffset, hiresWord[0]);
        destOffset += DISPLAY_SIZE_X;
        renderHiresScanLine(destOffset, hiresWord[1]);
        destOffset += DISPLAY_SIZE_X;
        renderHiresScanLine(destOffset, hiresWord[2]);
        destOffset += DISPLAY_SIZE_X;
        renderHiresScanLine(destOffset, hiresWord[3]);
        destOffset += DISPLAY_SIZE_X;
        renderHiresScanLine(destOffset, hiresWord[4]);
        destOffset += DISPLAY_SIZE_X;
        renderHiresScanLine(destOffset, hiresWord[5]);
        destOffset += DISPLAY_SIZE_X;
        renderHiresScanLine(destOffset, hiresWord[6]);
        destOffset += DISPLAY_SIZE_X;
        renderHiresScanLine(destOffset, hiresWord[7]);
    }

    private void resetHiresWords() {
        hiresWord[0] = 0;
        hiresWord[1] = 0;
        hiresWord[2] = 0;
        hiresWord[3] = 0;
    ...
    private void calcNextHiresWord(int hiresWordIndex, int byteEven, int byteOdd) {
    ...
    private void calcNextHiresWords(int address) {
     ...
     */
    private void renderDoubleHiresWord(int destOffset, int hiresNibble) {
    ...
    private void renderDoubleHiresScanLine(int destOffset, int hiresWord) {
    ...
    private void renderDoubleHiresBlock(int destOffset) {
        renderDoubleHiresScanLine(destOffset, hiresWord[0]);
        destOffset += DISPLAY_SIZE_X;
        renderDoubleHiresScanLine(destOffset, hiresWord[1]);
        destOffset += DISPLAY_SIZE_X;
        renderDoubleHiresScanLine(destOffset, hiresWord[2]);
        destOffset += DISPLAY_SIZE_X;
        renderDoubleHiresScanLine(destOffset, hiresWord[3]);
        destOffset += DISPLAY_SIZE_X;
        renderDoubleHiresScanLine(destOffset, hiresWord[4]);
        destOffset += DISPLAY_SIZE_X;
        renderDoubleHiresScanLine(destOffset, hiresWord[5]);
        destOffset += DISPLAY_SIZE_X;
        renderDoubleHiresScanLine(destOffset, hiresWord[6]);
        destOffset += DISPLAY_SIZE_X;
    ...
    private void calcNextDoubleHiresWords(int address) {
